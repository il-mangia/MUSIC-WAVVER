...
- Updated user interface
- Added video downloader (MP4 / MOV) with best available quality
- Improved playlist downloader performance (faster downloads)
...
- Launcher: Automatically download FFmpeg for Windows (no admin, user PATH)
- Launcher: Multilingual (it/en/es/de)
- Playlist download via playlists.py (external, PyInstaller compatible)
- Deezer best match auto-selection search
- Modernized UI, no emojis in the code
- Integrated yt-dlp updater
- Playlist URL log
...
- Stable and fastest
- Updated yt_dlp to v2026.02.06, due to errors.
- Updated Libraries
...
- I am working for a better Debian-Compatibile version. I need a .deb? How yo create a .deb??
- I'm trying to figure out how to install ffmpeg directly from the launcher. It's going to be hard.
...
- Professional icon integration - uses logo.ico for all windows
- Logo support - displays logo.png in title bar
- Improved button styling with modern hover effects
- Increased timeouts from 15 to 30 seconds for better WiFi performance
- Enhanced retry system for slow connections (3 attempts with configurable delays)
...
- New "Play" button to open downloaded file
- yt-dlp updated
